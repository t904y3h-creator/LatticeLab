...
Renderer2DWGPU::Renderer2DWGPU(World& simBox, wgpu::Device device, wgpu::TextureFormat surfaceFormat, const GpuAtomBuffers& atomBuffers)
    : RendererWGPU(simBox, device, surfaceFormat, atomBuffers) {
